...
export const checkUser = async () => {
  ...
  try {
    ...
    const requestUrl = `${STRAPI_URL}/api/users?filters[clerkId][$eq]=${user.id}`;
    console.log(`🔍 checkUser: Fetching from ${requestUrl}`);
    console.log(`🔑 checkUser: Token prefix: ${STRAPI_API_TOKEN.substring(0, 5)}...`);
